    ...
    <div className="min-h-screen bg-black px-4 sm:px-6 lg:px-8 py-12">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-[#DFDFDF] mb-8 max-w-2xl">
          Explore snapshots from our vibrant community events, workshops, and
          meetups. These moments capture the essence of learning, collaboration,
          and growth within our tech ecosystem.
        </p>
