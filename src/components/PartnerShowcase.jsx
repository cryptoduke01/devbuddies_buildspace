  ...
  return (
    ...
    >
      <div className={`flex flex-col items-center justify-center h-full transition-opacity duration-300 ${isHovered ? 'opacity-0' : 'opacity-100'}`}>
        <img src={logo} alt={name} className="w-24 h-24 object-contain mb-4 rounded-full" />
        <h3 className="text-xl font-bold text-white text-center">{name}</h3>
      </div>
      <div className={`absolute inset-0 bg-[#44967E] p-6 flex items-center justify-center transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
...
const PartnerShowcase = () => {
  const partners = [
    {
      name: "Learnspaces",
      logo: "/src/assets/learnspaces.jpg",
      description: "study, share, collaborate and focus with your squad."
    },
    {
      name: "Alpha Blue Foundation",
      logo: "/src/assets/learnspaces.jpg",
      description: "Nonprofit organization equpping individuals with digital skills for tech growth."
    },
    {
      name: "Blue Algorithm Technologies",
      logo: "/src/assets/learnspaces.jpg",
      description: "Leading AI and machine learning solutions provider for businesses."
    },
  ];
    ...
    <section className="py-16 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <p className="text-white text-lg mb-6">interested in partnering with us?</p>
